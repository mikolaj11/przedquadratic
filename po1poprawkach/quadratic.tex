...
background details for the proof of \cref{mainthm}.
...
a map from the set $T_{k}^{\odd}$, but it can be 
seen that each map from the set can be produced.
(At all times one of the edges 
